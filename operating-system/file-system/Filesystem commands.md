...
```
# File name
- [Wildcard character](operating-system/file-system/Wildcard%20character.md) 
# Listing files
...
# Create a link
- [Hard link and Soft link](operating-system/file-system/Hard%20link%20and%20Soft%20link.md)
- `ln` command
## Soft link
```bash
