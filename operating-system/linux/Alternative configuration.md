#ubuntu #operating-system #java #python #fedora  #go #fedora #linux #rhel #centos-stream 

- The example is the same as configuration for Python alternatives. This can be applied for other programming languages.
# List alternatives
