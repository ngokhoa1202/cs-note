...
```C title='Peterson solution on single-threaded operating system'
...
# Proof
- [Peterson's solution](Peterson's%20solution.md) is proven to satisfy all of the requirements for a solution to [Critical section problem](operating-system/unix/linux/process/process-synchronization/Critical%20section%20problem.md)
## Mutual exclusion
