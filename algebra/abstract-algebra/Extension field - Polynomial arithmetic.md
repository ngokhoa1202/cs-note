...
- Multiplicative inverse: using [Extended Euclidean algorithm](discrete-math/number-theory/Extended%20Euclidean%20algorithm.md) $$A(x) \times A^{-1}(x) \equiv 1 \space (mod \space P(x))$$
- 