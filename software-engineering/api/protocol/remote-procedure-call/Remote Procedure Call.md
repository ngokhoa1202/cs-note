#software-architecture #rpc #distributed-systems #api #client-server #network-protocol
...
### [[gRPC]]
High-performance RPC framework using Protocol Buffers and HTTP/2. Supports all streaming patterns and polyglot development.

### [[Apache Thrift]]
Cross-language RPC framework with pluggable serialization and transport. Developed by Facebook, supports multiple protocols.

### [[JSON-RPC]]
Lightweight remote procedure call protocol encoded in JSON. Simple specification, widely used in web applications and blockchain.

### Others
- **XML-RPC**: Legacy protocol using XML over HTTP
- **SOAP**: Enterprise web services with WS-* standards
- **Apache Avro RPC**: Schema-based RPC with dynamic typing
- **CORBA**: Legacy distributed object middleware
