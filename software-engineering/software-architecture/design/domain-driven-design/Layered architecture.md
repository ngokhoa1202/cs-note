...
- It does <mark style="background: #e4e62d;">not contain business rules</mark> , but only coordinates delegates tasks to collaborations of domain objects in the next layer down. 
