...
# Design
- If object creation is complicated, we can implement [Prototype pattern](software-engineering/software-architecture/design/design-pattern/classical-pattern/creational-pattern/Prototype%20pattern.md) or [Singleton](Singleton.md) for an instance of a concrete product.
- Categorize concrete products into families to create abstract product factory.
# Characteristics
- Employ [Factory Method pattern](software-engineering/software-architecture/design/design-pattern/classical-pattern/creational-pattern/Factory%20Method%20pattern.md)
