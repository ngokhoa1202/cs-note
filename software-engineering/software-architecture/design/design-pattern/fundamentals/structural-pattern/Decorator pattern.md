#object-oriented-programming #design-pattern #software-engineering #software-architecture
...
- Decorator should not change Component's behavior [Liskov Substitution principle](SOLID.md#Liskov%20Substitution%20principle).
# Real example
