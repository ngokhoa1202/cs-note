#git #github #version-control #project-management #shell #file-system #software-engineering #ide 
#site-realibility-engineering #project-management #software-architecture 

# Basic branching
## Creating a new branch
- [Creating a new branch](site-reliability-engineering/version-control/git/git-branching/Git%20branching%20architecture.md#Creating%20a%20new%20branch)
## Switching a specific branch
- [Switching branches](site-reliability-engineering/version-control/git/git-branching/Git%20branching%20architecture.md#Switching%20branches)
...
```
- Remotely delete branch [Branch management](site-reliability-engineering/version-control/git/git-branching/Branch%20management.md)
# Basic merging
...
6. [Branch management](site-reliability-engineering/version-control/git/git-branching/Branch%20management.md)