...
- Use `git log` in [Viewing commit history](site-reliability-engineering/version-control/git/git-basics/Viewing%20commit%20history.md) to known the commit hash.
