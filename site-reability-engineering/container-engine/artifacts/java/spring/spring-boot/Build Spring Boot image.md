...
#continuous-delivery #shell #shell #rhel #spring-boot #ubuntu #debian
...
#### Java 21
```Dockerfile title='ontainerfile to build simple Spring Boot image based on Debian with Eclipse Temurin JDK 21'
