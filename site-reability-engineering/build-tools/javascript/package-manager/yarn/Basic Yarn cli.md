#cli #yarn #react #dependency-manager #javascript #typescript #site-realibility-engineering 
#continuous-delivery #continuous-integration 
# Create React project
- `yarn create react-app <app-name>`
# Set version
- `yarn set version <version>`
```Shell title='yarn set version examples'
...
```Shell title='yarn nodelinker examples'
...
```Shell title='yarnc.yaml example'
