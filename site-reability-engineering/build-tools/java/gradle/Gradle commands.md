#cli #operating-system #gradle #dependency-manager  #java #quarkus #spring #spring-boot #jakarta-ee  #scripting #continuous-integration #continuous-delivery 
# Syntax
```bash
...
```
# Build
- Normal build. [Task lifecycle](site-reability-engineering/build-tools/java/gradle/Gradle%20tasks.md#Task%20lifecycle)
```bash
./gradlew build
```
