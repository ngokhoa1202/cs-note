#software-engineering  #software-architecture #dependency-manager #continuous-integration #gradle #java #jakarta-ee #spring  #spring-boot #quarkus #operating-system #ubuntu #windows #configuration #installation #scripting 
# Purpose
...
- Refers to [Gradle tasks](site-reability-engineering/build-tools/java/gradle/Gradle%20tasks.md) for specific task APIs.
--- 
# References
...
5. [Gradle tasks](site-reability-engineering/build-tools/java/gradle/Gradle%20tasks.md) for Java plugin API to build Gradle project.