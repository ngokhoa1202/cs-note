#java #quarkus #rpc #grpc #os #computer-network #application-layer #google #cloud #transport-layer #software-engineering  #software-architecture #jakarta-ee #microservice #proxy-server 
