...
- The [Hibernate dirty checking](programming/java/jakarta-ee/jakarta-persistence-api/hibernate/transaction/Hibernate%20dirty%20checking.md) mechanism can lead to memory exhaustion because Hibernate allows caching entity instance within a Persistence Context.
...
2. [Persistence lifecycle](programming/java/jakarta-ee/jakarta-persistence-api/hibernate/transaction/Persistence%20lifecycle.md) 
