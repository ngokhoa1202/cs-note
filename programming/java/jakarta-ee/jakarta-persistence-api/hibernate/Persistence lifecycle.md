...
## Detached state
- The entity instance is ==no longer managed by the Persistence Context== as the transaction has already ended.
...
- [Entity manager](programming/java/jakarta-ee/jakarta-persistence-api/hibernate/Entity%20manager.md) 

# References
1. Java Persistence with Hibernate - 2th edition - Chapter 10: Managing data.
2. [Persistence context](programming/java/jakarta-ee/jakarta-persistence-api/hibernate/Persistence%20context.md) for Jakarta Persistence Context.           
