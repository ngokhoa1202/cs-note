#hibernate #sql #dbms #java #spring-jpa #entity-manager  #jakarta-ee #jpa
#transaction #entity-manager #nosql 

- Hibernate implements [Entity manager](programming/java/jakarta-ee/jakarta-persistence-api/Entity%20manager.md) API on top of Database vendor drivers (PostgreSQL, Oracle, MySQL, ...)  and obviously ==creates an abstract layer.==
...
- The [Hibernate dirty checking](programming/java/jakarta-ee/jakarta-persistence-api/hibernate/Hibernate%20dirty%20checking.md) mechanism can lead to memory exhaustion because Hibernate allows caching entity instance within a Persistence Context.
...
2. [Persistence lifecycle](programming/java/jakarta-ee/jakarta-persistence-api/hibernate/Persistence%20lifecycle.md) 
3. 
