...
- A bean can be simply understood as ==injectable objects==:
	...
	- Jakarta EE resources:
		...
		- ...
	- Persistence contexts (like [Entity manager](programming/java/jakarta-ee/jakarta-persistence-api/Entity%20manager.md)).
...
# Qualifier
- Specifies *which concrete implementation* should be injected into a dependency.
## Example
- Base class
```java
package greetings;
