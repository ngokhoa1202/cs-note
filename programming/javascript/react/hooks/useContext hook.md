#react  #javascript  #hook #dom  #jsx #functional-programming 

# Characteristics
- Similar to [Lifting state up](programming/javascript/react/hooks/Lifting%20state%20up.md), `useContext` is used to ==share state among components== but ==without passing props into the virtual DOM tree==.
