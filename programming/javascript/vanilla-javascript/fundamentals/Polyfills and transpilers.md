...
# Polyfills
- Polyfill is scripts (functions or modules) inserted used to provide modern functionality on older browsers that do not natively support it, which means that it re-implements the missing functions or modules.
