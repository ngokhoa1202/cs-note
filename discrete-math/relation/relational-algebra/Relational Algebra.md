...
## Sigma SELECT
- Select a <mark style="background: #e4e62d;">subset of tuples</mark> from a relation according to a specific <mark style="background: #e4e62d;">selection condition</mark> - horizontal partitioning.
...
## Pi Project
- Keeps specific attributes and discard other attributes - vertical partitioning.
